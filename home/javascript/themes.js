...
function monthcheck() {
    if (month == 10) {
        if (page == 'index') {
            ...
            playlist.unshift("graphics/themes/halloween/Monster%20Mash.mp3");
            playing.src = "graphics/themes/halloween/Monster%20Mash.mp3";
        } else if (page == 'pics') {
            var theme_overlay = document.querySelector(".theme_overlay");
    ...
    if (month == 12) {
        if (page == 'index') {
            ...
            playlist.unshift("graphics/themes/crimbo/It's%20Beginning%20To%20Look%20A%20Lot%20Like%20Christmas.mp3");
            playing.src = "graphics/themes/crimbo/It's%20Beginning%20To%20Look%20A%20Lot%20Like%20Christmas.mp3";
        } else if (page == 'pics') {
            var theme_overlay = document.querySelector(".theme_overlay");
            var theme_4 = document.querySelector(".theme_4");
            theme_overlay.classList.toggle("crimbo");
    ...
    if (month == 2 && date == 14) {
        if (page == 'index') {
            ...
            playlist.unshift("graphics/themes/valentine/Valentines%20Day.mp3");
            playing.src = "graphics/themes/valentine/Valentines%20Day.mp3";
        } else if (page == 'pics') {
            var theme_overlay = document.querySelector(".theme_overlay");
            var theme_4 = document.querySelector(".theme_4");
            theme_overlay.classList.toggle("valentine");
    ...
    if (month == 4) {
        if (page == 'index') {
            ...
            playlist.unshift("graphics/themes/easter/Rappin%20For%20Jesus.mp3");
            playing.src = "graphics/themes/easter/Rappin%20For%20Jesus.mp3";
        } else if (page == 'pics') {
            var theme_overlay = document.querySelector(".theme_overlay");
            var theme_4 = document.querySelector(".theme_4");
            theme_overlay.classList.toggle("easter");
